...
if ((envval = getenv("OQS_OID_MLKEM512"))) oqs_oid_alg_list[0] = envval;

if ((envval = getenv("OQS_OID_P256_MLKEM512"))) oqs_oid_alg_list[2] = envval;
if ((envval = getenv("OQS_OID_X25519_MLKEM512"))) oqs_oid_alg_list[4] = envval;
if ((envval = getenv("OQS_OID_BP256_MLKEM512"))) oqs_oid_alg_list[6] = envval;
if ((envval = getenv("OQS_OID_MLKEM768"))) oqs_oid_alg_list[8] = envval;

if ((envval = getenv("OQS_OID_P384_MLKEM768"))) oqs_oid_alg_list[10] = envval;
if ((envval = getenv("OQS_OID_X448_MLKEM768"))) oqs_oid_alg_list[12] = envval;
if ((envval = getenv("OQS_OID_BP384_MLKEM768"))) oqs_oid_alg_list[14] = envval;
if ((envval = getenv("OQS_OID_X25519MLKEM768"))) oqs_oid_alg_list[16] = envval;
if ((envval = getenv("OQS_OID_SECP256R1MLKEM768"))) oqs_oid_alg_list[18] = envval;
if ((envval = getenv("OQS_OID_MLKEM1024"))) oqs_oid_alg_list[20] = envval;

if ((envval = getenv("OQS_OID_P521_MLKEM1024"))) oqs_oid_alg_list[22] = envval;
if ((envval = getenv("OQS_OID_SECP384R1MLKEM1024"))) oqs_oid_alg_list[24] = envval;
if ((envval = getenv("OQS_OID_BP512_MLKEM1024"))) oqs_oid_alg_list[26] = envval;
if ((envval = getenv("OQS_OID_BIKEL1"))) oqs_oid_alg_list[28] = envval;

if ((envval = getenv("OQS_OID_P256_BIKEL1"))) oqs_oid_alg_list[30] = envval;
if ((envval = getenv("OQS_OID_X25519_BIKEL1"))) oqs_oid_alg_list[32] = envval;
if ((envval = getenv("OQS_OID_BIKEL3"))) oqs_oid_alg_list[34] = envval;

if ((envval = getenv("OQS_OID_P384_BIKEL3"))) oqs_oid_alg_list[36] = envval;
if ((envval = getenv("OQS_OID_X448_BIKEL3"))) oqs_oid_alg_list[38] = envval;
if ((envval = getenv("OQS_OID_HQC128"))) oqs_oid_alg_list[40] = envval;

if ((envval = getenv("OQS_OID_P256_HQC128"))) oqs_oid_alg_list[42] = envval;
if ((envval = getenv("OQS_OID_X25519_HQC128"))) oqs_oid_alg_list[44] = envval;
if ((envval = getenv("OQS_OID_HQC192"))) oqs_oid_alg_list[46] = envval;

if ((envval = getenv("OQS_OID_P384_HQC192"))) oqs_oid_alg_list[48] = envval;
if ((envval = getenv("OQS_OID_X448_HQC192"))) oqs_oid_alg_list[50] = envval;
if ((envval = getenv("OQS_OID_HQC256"))) oqs_oid_alg_list[52] = envval;

if ((envval = getenv("OQS_OID_P521_HQC256"))) oqs_oid_alg_list[54] = envval;

#define OQS_KEMOID_CNT 54+2
#else
