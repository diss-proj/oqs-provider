...
if ((envval = getenv("OQS_OID_BP256_MLKEM512"))) oqs_oid_alg_list[38] = envval;
if ((envval = getenv("OQS_OID_MLKEM768"))) oqs_oid_alg_list[40] = envval;

if ((envval = getenv("OQS_OID_P384_MLKEM768"))) oqs_oid_alg_list[42] = envval;
if ((envval = getenv("OQS_OID_X448_MLKEM768"))) oqs_oid_alg_list[44] = envval;
if ((envval = getenv("OQS_OID_BP384_MLKEM768"))) oqs_oid_alg_list[46] = envval;
if ((envval = getenv("OQS_OID_X25519MLKEM768"))) oqs_oid_alg_list[48] = envval;
if ((envval = getenv("OQS_OID_SECP256R1MLKEM768"))) oqs_oid_alg_list[50] = envval;
if ((envval = getenv("OQS_OID_MLKEM1024"))) oqs_oid_alg_list[52] = envval;

if ((envval = getenv("OQS_OID_P521_MLKEM1024"))) oqs_oid_alg_list[54] = envval;
if ((envval = getenv("OQS_OID_SECP384R1MLKEM1024"))) oqs_oid_alg_list[56] = envval;
if ((envval = getenv("OQS_OID_BP512_MLKEM1024"))) oqs_oid_alg_list[58] = envval;
if ((envval = getenv("OQS_OID_BIKEL1"))) oqs_oid_alg_list[60] = envval;

if ((envval = getenv("OQS_OID_P256_BIKEL1"))) oqs_oid_alg_list[62] = envval;
if ((envval = getenv("OQS_OID_X25519_BIKEL1"))) oqs_oid_alg_list[64] = envval;
if ((envval = getenv("OQS_OID_BIKEL3"))) oqs_oid_alg_list[66] = envval;

if ((envval = getenv("OQS_OID_P384_BIKEL3"))) oqs_oid_alg_list[68] = envval;
if ((envval = getenv("OQS_OID_X448_BIKEL3"))) oqs_oid_alg_list[70] = envval;
if ((envval = getenv("OQS_OID_BIKEL5"))) oqs_oid_alg_list[72] = envval;

if ((envval = getenv("OQS_OID_P521_BIKEL5"))) oqs_oid_alg_list[74] = envval;
