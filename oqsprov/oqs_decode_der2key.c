...
MAKE_DECODER(_ecbp, "bp256_mlkem512", bp256_mlkem512, oqsx, SubjectPublicKeyInfo);
...
MAKE_DECODER(_ecbp, "bp384_mlkem768", bp384_mlkem768, oqsx, SubjectPublicKeyInfo);
...
MAKE_DECODER(_ecbp, "bp512_mlkem1024", bp512_mlkem1024, oqsx, SubjectPublicKeyInfo);
